(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function setImage(element, imagePath, useSrcset, cssBackgroundPrefix) {
    ...
    function setImageAndSources(setSourcesFn) {
        return function (element, imagePath, useSrcset, cssBackgroundPrefix) {
    ...
    var SharedHooks = /** @class */ (function (_super) {
        ...
        SharedHooks.prototype.loadImage = function (attributes) {
            ...
            var element = attributes.element, useSrcset = attributes.useSrcset, imagePath = attributes.imagePath, decode = attributes.decode, cssBackgroundPrefix = attributes.cssBackgroundPrefix;
            var img;
            if (isImageElement(element) && isChildOfPicture(element)) {
        ...
        SharedHooks.prototype.setErrorImage = function (error, attributes) {
            var element = attributes.element, useSrcset = attributes.useSrcset, errorImagePath = attributes.errorImagePath, cssBackgroundPrefix = attributes.cssBackgroundPrefix;
        ...
        SharedHooks.prototype.setLoadedImage = function (imagePath, attributes) {
            var element = attributes.element, useSrcset = attributes.useSrcset, cssBackgroundPrefix = attributes.cssBackgroundPrefix;
    ...
    LazyLoadImageDirective.propDecorators = {
        ...
        cssBackgroundPrefix: [{ type: core.Input }],
